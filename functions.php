...
function dtc_setup() {
	/*
		...
		* If you're building a theme based on dtc, use a find and replace
		* to change 'dtc' to the name of your theme in all the template files.
		*/
 ...
 */
function dtc_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'dtc_content_width', 640 );
}
 ...
 */
function dtc_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'dtc' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'dtc' ),
